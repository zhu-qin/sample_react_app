...
var _mainReducer = __webpack_require__(31);

var _mainReducer2 = _interopRequireDefault(_mainReducer);

var _mapDispatchToActions = __webpack_require__(30);

var _mapDispatchToActions2 = _interopRequireDefault(_mapDispatchToActions);
  ...
  _createClass(Entry, [{
    ...
    value: function componentDidMount() {
      ...
      this.unsubscribe = store.subscribe(function () {
        return _this2.setState({ appState: store.getState() });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_mainComponent2.default, { appState: this.state.appState, actions: this.props.actions })
      );
    }
  }]);
...
var store = _redux2.default.createStore(_redux2.default.combineReducers(_mainReducer2.default), {});
var actions = (0, _mapDispatchToActions2.default)(store.dispatch);

document.addEventListener('DOMContentLoaded', function (e) {
  _reactDom2.default.render(_react2.default.createElement(Entry, { store: store, actions: actions }), document.getElementById('root'));
});

setTimeout(function () {
  return actions.setCurrentUser({
    firstName: 'Billy',
    lastName: 'Bob'
  });
}, 1000);
...
function createStore(mainReducer) {
  ...
  var listeners = [];
  var currentReducer = mainReducer;
...
function combineReducers(reducers) {
  ...
  return function mainReducer(state, action) {
    ...
    Object.keys(reducers).forEach(function (key) {
      var previousStateSlice = state[key];
      var nextStateSlice = reducers[key](previousStateSlice, action);
  ...
  return function (createStore) {
    return function () {
      ...
      var _dispatch = function dispatch() {
        return console.log('Replace this dispatch');
      };
